...
class Inject_data_taspen extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->model('Injecttaspen_model');
 ...
 $start = intval($this->input->get('start'));
                ...
                $pns = $this->Injecttaspen_model->get_all();
        ...
        $data = array( 
            ...
            'isi'        =>'admin/injecttaspen/injecttaspen_list',);
    ...
    function import()
    {
          $data = array( 'title'      =>'Inject Data TASPEN',
          	'isi'        =>'admin/injecttaspen/injecttaspen_import');
         $this->load->view('admin/layout/wrapper', $data, FALSE); 
    }
...
if($id == null || $tgl_lapor == null){
            ...
            redirect('admin/inject_data_taspen');
}
...
$result = array();
         ...
         $this->db->update_batch('inject_data_taspen', $result, 'id');
    ...
    { 
        ...
        if (!$this->upload->do_upload()) {
            ...
            redirect('admin/inject_data_taspen/import');
    }else{
     ...
     $this->db->insert_batch('inject_data_taspen', $data);
    ...
    {
        $row = $this->Injecttaspen_model->get_by_id($id);

        if ($row) {
            $this->Injecttaspen_model->delete($id);
            $this->session->set_flashdata('message', 'Delete Record Success');
            redirect(base_url('admin/Inject_data_taspen'));
        } else {
