...
class Karyawan extends CI_Controller
{
    ...
    public function create_action() 
    {
		...
		'no_hp' => $this->input->post('no_hp',TRUE),
		'id_bidang' => $this->input->post('id_bidang',TRUE),
		'foto' => upload_gambar_biasa('karyawan','gambar/thumb','jpg|png|jpeg',10000,'foto'),
	    );  
        } 
...
$gettbcabang = $this->Karyawan_model->getcabang();
        if ($row) {
            $data = array(
                'button' => 'Update',
        ...
        'cabang' => set_value('foto', $row->id_cabang),
'gettbcabang' => $gettbcabang,
    ...
    {
        $bidang = $this->Karyawan_model->bidang();
 $cabang = $this->Karyawan_model->getcabang();
...
/* Generated by Harviacode Codeigniter CRUD Generator 2020-06-24 19:34:26 */
/* http://harviacode.com */