...
class User extends CI_Controller {
	...
	{
		parent::__construct();
		$this->load->model('user_model','Cabang_model');
...
$valid->set_rules('id_cabang','id_cabang','required',
			array(	'required' 		=>'Id cabang harus diisi'));
		...
		$cabang = $this->user_model->getcabang();
