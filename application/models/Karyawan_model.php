...
class Karyawan_model extends CI_Model
{
    ...
    function __construct()
    {
        ...
        $this->db->select('karyawan.*,bidang.*,cabang.nama_cabang');
    ...
    function get_all()
    {
        $this->db->where('id_cabang','13');
        
        $this->db->order_by($this->id, $this->order);
        return $this->db->get($this->table)->result();
    }

    function get_data_karyawan($id_cabang)
    {
    ...
    function get_spv($nama_spv){

        $this->db->where('id_karyawan', $nama_spv);
        return $this->db->get($this->table)->row();
    
    }
    function getkaryawantoladmin($getidk){
        $this->db->where($this->id, $getidk);
        return $this->db->get($this->table)->row();
    }
