...
<div class="col-md-4" style="margin-bottom: 10px">
    ...
    <i class="fa fa-plus"> </i> Tambah </a> 
     ...
     <a href="<?php echo base_url('admin/customer/import') ?>" class="btn btn-primary">
  ...
  <!-- Buka java Tabel -->
        ...
        <?php
			...
			<td style="text-align:center" width="80px">
				<?php 
				echo anchor(base_url('admin/customer/read/'.$customer->id_cus_aktif),'<i class="btn btn-primary btn-s fa fa-eye" title="read"> </i> '); 
				echo ' '; 
				echo anchor(base_url('admin/customer/update/'.$customer->id_cus_aktif),'<i class="btn btn-warning btn-s fa fa-edit" title="Edit"> </i>'); 
				echo '  '; 
				echo anchor(base_url('admin/customer/delete/'.$customer->id_cus_aktif),'<i class="btn btn-danger btn-s fa fa-trash" title="Delete"> </i>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
