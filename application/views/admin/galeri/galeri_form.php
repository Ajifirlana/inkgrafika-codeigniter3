...
<div class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form">
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data">
	    <div class="form-group col-md-12"><label for="varchar">Galeri</label>
            ...
            if ($galeri !== '') {
                ...
                <div>
                    *) Gambar Sebelumnya <br>
                    <img src="<?php echo base_url('gambar/thumb/'.$galeri) ?>" style="width: 100px;height: 100px;">
                </div>
                <?php
            } else {
                echo "tidak ada";
	    ...
	    <a href="<?php echo base_url('admin/galeri') ?>" class="btn btn-danger">Cancel</a>
        </div>
	</form><br>
    </div>
    </div>
