...
<div class="col-md-4" style="margin-bottom: 10px">
     ...
     <a href="<?php echo base_url('admin/inject_data_taspen/import') ?>" class="btn btn-primary">
...
?>
 ...
 <form method="POST" action="<?php echo base_url() ?>admin/inject_data_taspen/update_multiple">
...
<th>Action</th>
     ...
     <td><?php echo date('d-m-Y',strtotime($customer->tgl_lapor)); ?></td> 
      <td style="text-align:center" width="100%">
                <?php  
                echo anchor(base_url('admin/Inject_data_taspen/delete/'.$customer->id),'<i class="btn btn-danger btn-s fa fa-trash" title="Delete"> </i>','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
                ?>
            </td>
		</tr>
                <?php
        ...
        <div class="col-md-7">
        <form method="POST" action="<?php echo base_url("admin/inject_data_taspen/delete_all");?>">
            <div class="form-group">
