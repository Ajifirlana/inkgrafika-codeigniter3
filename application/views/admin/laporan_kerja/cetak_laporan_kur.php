...
header("Content-type: application/vnd-ms-excel");
 header("Content-Disposition: attachment; filename=Data Laporan Kur.xls");
?>
<div align="center">
...
<th>PAJAK</th>
        ...
        <?php
          $totfee = 0;
            ...
            <td><?php echo $laporan_kerja->no_ktp ?></td>
            ...
            <td><?php echo date("d-m-Y",strtotime($laporan_kerja->tanggal_realisasi)); ?></td>
           <td>
