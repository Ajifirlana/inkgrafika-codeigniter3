...
<div class="col-md-4" style="margin-bottom: 10px">
    ...
    <!--<a href="<?php echo base_url('admin/laporan_kerja/import') ?>" class="btn btn-primary">-->
    <!--<i class="fa fa-plus"> </i> Inject </a> -->
...
?>
  ...
  <!-- Buka java Tabel -->
    ...
    <?php }?>
        ...
        <?php if($this->session->userdata('akses_level') == 'Admin'){?>	<td><?php echo $laporan_kerja->nama ?> - <b><?php echo $laporan_kerja->bagian_karyawan ?></b></td>
    <?php }?>
			...
			<!-- <td> <a href="<?php echo $laporan_kerja->nama_cus ?>" target=_blank ></a></td> -->
            <td>       
