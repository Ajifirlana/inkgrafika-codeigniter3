	<button class="btn btn-success" data-toggle="modal" data-target="#modal4">
	<i class="fa fa-print"></i>REPORT KUR
</button>
...
<div class="modal-header alert alert-success">
	...
	<h4 class="modal-title" id="myModalLabel">LAPORAN KUR</h4>
</div>

<div class="modal-body">

	<h4 align="center">Cetak Jenis Pinjaman</h4>			
	<form action="<?php echo base_url('admin/laporan_kerja_admin/cetak_kur') ?>" method="post" target="_blank">
