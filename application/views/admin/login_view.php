...
<head>
    ...
    <!-- App styles -->
    <link rel="stylesheet" href="<?php echo base_url() ?>assets/homer/fonts/pe-icon-7-stroke/css/pe-icon-7-stroke.css" />
...
<div class="login-container">
    ...
    <div class="row">
        <div class="col-md-12 text-center">Aplikasi Grafika Digital Printing <br/> 
