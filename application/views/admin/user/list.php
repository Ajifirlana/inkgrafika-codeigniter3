...
<?php $i = 1; foreach($user as $user) { ?>
    <tr>
        ...
        <td><?php if($user->akses_level == 'Admin'){ echo "---"; }else{?><?php echo $user->nama_cabang ?>
            <?php }?></td> 
...
<?php ; foreach($admin as $adm) { ?>
    <tr>
        ...
        <td><?php echo $adm->username ?> - <?php echo $adm->akses_level ?></td>
        <td><?php if($adm->akses_level == 'Admin'){ echo "---"; }else{?><?php echo $adm->nama_cabang ?>
            <?php }?></td> 
        ...
        <td>
        <a href="<?php echo base_url('admin/user/edit/'.$adm->id_user) ?>" class="btn btn-warning btn-xs"><i class="fa fa-edit"></i> Edit</a>  
