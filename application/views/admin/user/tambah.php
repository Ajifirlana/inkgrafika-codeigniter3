...
<div class="form-horizontal form-bordered" data-parsley-validate="true" name="demo-form">
    ...
    <div class="form-group col-md-6">
    	  ...
    	  <label for="int">Karyawan</label>
            <select name="id_karyawan" class="form-control js-example-basic-multiple" onChange="get_data(this.value)">
                <option>--Pilih--</option>
                <?php foreach ($karyawan as $karyawan) { ?>

                    <option value="<?php echo $karyawan->id_karyawan ?>" <?php if($karyawan->id_karyawan==$karyawan->id_karyawan){echo "selected"; } ?>>
