      ...
      <div class="col-xs-12 col-sm-12 col-md-12">
         <div class="row">     
          <div class="col-xs-12 col-sm-12 col-md-12 wow zoomIn animated textright" data-wow-delay=".1s">           
                      ...
                      <div id="owl-buletin" class="owl-carousel">
                        <?php foreach($buletin as $row){?>
                        <div class="item">
                            <div class="imghover" data-toggle="modal" data-target="#exampleModa2" data-whatever="@mdo">
                             <table border="0">
                               <tr>
                                <td>&nbsp;</td>
                                 <td> <img width="100%" src="<?php echo base_url('gambar/thumb/'.$row->buletin)?>" alt="Owl Image"> </td>
                               </tr>
                             </table>
                         </div>
                        </div>
